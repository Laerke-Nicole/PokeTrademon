        ...
        <div>
          ...
          <div class="flex justify-between items-center pb-6">
            ...
            <div class="flex justify-end items-end">
              <button @click="toggleAboutUs" class="text-4xl text-red-400 hover:text-red-700">
                &times;
              </button>
            </div>
          </div>
          ...
          <div v-if="aboutUsItem">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div class="flex flex-col gap-2">
                ...
                <input
                  type="text"
                  v-model="aboutUsItem.aboutUsTitle"
                  placeholder="Title"
                  minlength="2"
                  maxlength="100"
                  required
              ...
              <div class="flex flex-col gap-2">
                ...
                <textarea
                  type="text"
                  v-model="aboutUsItem.aboutUsText"
              ...
              <div class="flex flex-col gap-2">
                ...
                <textarea
                  type="text"
                  v-model="aboutUsItem.valuesSubTitle"
              ...
              <div class="flex flex-col gap-2">
                ...
                <input
                  type="text"
                  v-model="aboutUsItem.valueOneTitle"
              ...
              <div class="flex flex-col gap-2">
                ...
                <input
                  type="text"
                  v-model="aboutUsItem.valueTwoTitle"
              ...
              <div class="flex flex-col gap-2">
                ...
                <input
                  type="text"
                  v-model="aboutUsItem.valueThreeTitle"
              ...
              <div class="flex flex-col gap-2">
                ...
                <textarea
                  type="text"
                  v-model="aboutUsItem.valueThree"
