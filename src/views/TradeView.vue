    ...
    <div class="max-w-screen-xl mx-auto px-4">
      ...
      <div v-else>
            ...
            >
              <div class="flex justify-between pb-2">
                <div class="font-semibold dark-text">
                  From: {{ extractUsername(offer.senderId) }}
                </div>
                <span
              ...
              <p class="text-sm dark-text">
                <strong>They offer:</strong> {{ formatCardList(offer.senderCards) }}
              </p>
              <p class="text-sm dark-text">
                <strong>They want:</strong> {{ formatCardList(offer.receiverCards) }}
              </p>
              <div class="pt-4 flex flex-col space-y-2">
                ...
                <div v-else>
                  ...
                  <p v-if="!canFulfillTrade(offer.receiverCards)" class="text-xs text-red-500 pt-1">
        ...
        <div v-if="activeTab === 'incoming'">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            >
              <div class="flex justify-between pb-2">
                <div class="font-semibold dark-text">
                  From: {{ extractUsername(trade.senderId) }}
                </div>
                <span
                  :class="[
              ...
              <p class="text-sm dark-text">
                <strong>They offer:</strong> {{ formatCardList(trade.senderCards) }}
              </p>
              <p class="text-sm dark-text">
                <strong>They want:</strong> {{ formatCardList(trade.receiverCards) }}
              </p>
        ...
        <div v-else-if="activeTab === 'outgoing'">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            >
              <div class="flex justify-between pb-2">
                <div class="font-semibold dark-text">
                  To: {{ extractUsername(trade.receiverId) || 'Anyone (Open)' }}
                </div>
                <span
                  :class="[
                    'text-xs px-2 py-1 rounded-full font-semibold',
              ...
              <p class="text-sm dark-text">
                <strong>You offer:</strong> {{ formatCardList(trade.senderCards) }}
              </p>
              <p class="text-sm dark-text">
                <strong>You want:</strong> {{ formatCardList(trade.receiverCards) }}
              </p>
            </div>
          </div>
        </div>
        ...
        <div v-else-if="activeTab === 'completed'">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <div
              v-for="trade in filteredCompleted"
              :key="trade._id"
              class="bg-white p-4 rounded-xl shadow-md border"
            >
              <div class="flex justify-between pb-2">
                <div class="font-semibold dark-text">
                  <span v-if="isTradeSender(trade, userId)">
                    To: {{ extractUsername(trade.receiverId) }}
                  </span>
              ...
              <p class="text-sm dark-text">
                <strong>You offered:</strong> {{ formatCardList(trade.senderCards) }}
              </p>
              <p class="text-sm dark-text">
                <strong>You wanted:</strong> {{ formatCardList(trade.receiverCards) }}
              </p>
            </div>
          </div>
        </div>
...
// ✅ NEW UTILS
import { isTradeSender, extractUsername, formatCardList } from '../modules/helpers/tradeUtils'
